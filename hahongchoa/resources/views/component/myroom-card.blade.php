@section('myroom')
        ...
        @foreach($myrooms as $myroom)
            <div class="col-md-4 col-12 mt-2 border-0" style="height:auto;">
                ...
                <div class="card-body border pb-1 pt-0 ">
                    <div class="row">
                        <p class=" col p-0 m-0 color-dark-blue-fond threedotother_text"
                           style="font-size:18px;">{{$myroom->name_typeBuilder}}{{$myroom->name}}</p>
                    </div>
                    <div class="row">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <form action="/managerroom/{{$myroom->roomid}}" method="post">
                                ...
                                <button type="button"
                                        class="btn text-black-50 btn-secondary col-md-5 col-6 bg_corner border-dark"
    ...
    @else
        <div class="col-12 d-flex justify-content-center">
            <img src="{{asset('icon/nodata.png')}}" class="img-fluid" alt="">
        </div>
